...
def check_dependencies():
    ...
    try:
        if importlib.util.find_spec("flask_socketio") is None:
            raise ImportError
        ...
        try:
            subprocess.check_call(
                [sys.executable, "-m", "pip", "install", "flask-socketio"]
            )
...
def main():
    ...
    print_warning(
        "Your browser will show a security warning. Click 'Advanced' then 'Proceed' to continue."
    )
    print()
